...
def search():
    ...
    try:
        ...
        messagebox.showinfo(title="Error", message="No records for this Website.")
    except FileNotFoundError:
        messagebox.showinfo(title="Error", message="No data file found.")
    else:
        username_check = data[website_check]["username"]
        password_check = data[website_check]["password"]
        messagebox.showinfo(title=website_check, message=f"Username: {username_check}"
